sap.ui.require([
  ...
  var sViewName = "com.flexso.portal.myorders.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.flexso.portal.myorders"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.flexso.portal.myorders"
            });
        }
      }
